...
const Experience = () => {
	return (
		<div
			id="experience"
			className="relative w-full h-auto pt-32 pb-40 lg:pt-44 lg:pb-64 dark:bg-darksecondary bg-softblue px-sectionpxsm lg:px-sectionpxlg xl:px-sectionpxxl"
		>
			{/* Experience Title */}
			<h1 className="text-5xl xl:text-[80px] font-semibold text-center dark:text-white text-black md:text-6xl lg:text-[70px]">
				My career path as{" "}
			...
			<div className="flex flex-col items-center justify-between pt-20 lg:flex-row lg:pt-36 md:flex-row gap-7 lg:gap-5 xl:gap-7 md:gap-5 h-fit">
				{/* Experience 1 */}
				<div className="w-full pb-8 text-black bg-white lg:pb-7 px-7 lg:px-5 pt-7 lg:pt-5 dark:text-white rounded-xl dark:bg-darktertiary">
					...
					<h1 className="text-[40px] lg:text-3xl xl:text-4xl font-medium mt-14 leading-tight">
						UI/UX Designer
					</h1>
					<p className="text-lg font-light lg:text-[15px] xl:text-[17px] mt-14">
						May 2023 - Present
					</p>
					<div className="items-center w-full pt-3 pb-[15px] mt-7 text-center rounded-lg dark:bg-white bg-black">
						<p className="text-[17px] lg:text-[15px] xl:text-[17px] font-medium text-white dark:text-black">
							United States
						</p>
					</div>
					<div className="items-center w-full pt-3 pb-[15px] mt-4 text-center rounded-lg border-[1px] border-slate-300 dark:border-slate-500">
						<p className="text-[17px] lg:text-[15px] xl:text-[17px] font-medium dark:text-white text-black">
							Contract
						</p>
					</div>
					<div className="flex items-center justify-start gap-4 mt-16">
						...
						<p className="text-lg lg:text-[15px] xl:text-[17px] font-light">
				...
				<div className="w-full pb-8 text-white bg-purple-700 lg:pb-7 px-7 lg:px-5 lg:pt-5 pt-7 rounded-xl">
					...
					<h1 className="text-[40px] xl:text-4xl lg:text-3xl font-medium mt-14 leading-tight">
						UI/UX Designer
					</h1>
					<p className="text-lg font-light xl:text-[17px] lg:text-[15px] mt-14">
						Nov 2022 - May 2023
					</p>
					<div className="items-center w-full pt-3 pb-[15px] mt-7 text-center rounded-lg bg-white">
						<p className="text-[17px] lg:text-[15px] xl:text-[17px] font-medium text-black">
							Singapore
						</p>
					</div>
					<div className="items-center w-full pt-3 pb-[15px] mt-4 text-center rounded-lg border-[1px] border-slate-400">
						<p className="text-[17px] lg:text-[15px] xl:text-[17px] font-medium text-white">
							Full-time
						</p>
					</div>
					<div className="flex items-center justify-start gap-4 mt-16">
				...
				<div className="w-full pb-8 text-black bg-white lg:pb-7 px-7 lg:px-5 lg:pt-5 pt-7 dark:text-white rounded-xl dark:bg-darktertiary">
					...
					<p className="text-lg lg:text-[15px] xl:text-[17px] font-light mt-14">
						July 2020 - Present
					</p>
					<div className="items-center w-full pt-3 pb-[15px] mt-7 text-center rounded-lg dark:bg-white bg-black">
						<p className="text-[17px] lg:text-[15px] xl:text-[17px] font-medium text-white dark:text-black">
					...
					<div className="flex items-center justify-start gap-4 mt-16">
						...
						<p className="text-lg lg:text-[15px] xl:text-[17px] font-light">
							Developing our MVP mobile app &#40;fixit.id&#41;
						</p>
					</div>
					<div className="flex items-center justify-start gap-4 mt-4">
						<div className="flex self-start pt-1">
